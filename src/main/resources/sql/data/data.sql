...
VALUES
  (uuid('14c88e00-a325-4ac7-8c04-a43bc72cdc4a'), 'user1', 'user1', 'Mark', 'Zero', 'user1@user1.com', 'USER', 'ACTIVE',
   'I know some of us like really small text. (cough cough me) Because honestly text this big does looks odd in most layouts.');
INSERT INTO user_essence (user_essence_id, nickname, password, name, surname, email, role, status, about_of_self)
VALUES
  (uuid('7c9499cd-7a66-497b-9557-fb6b059c82d4'), 'user2', 'user2', 'Steve', 'Johnson', 'user2@user2.com', 'USER', 'ACTIVE',
   'Some text should be');
INSERT INTO user_essence (user_essence_id, nickname, password, name, surname, email, role, status, about_of_self)
VALUES
  (uuid('7c20a4d7-5f9b-416f-a910-b13a816ba90b'), 'admin', 'admin', 'Petr', 'Stevenson', 'USER@USER.com', 'ADMIN', 'ACTIVE',
